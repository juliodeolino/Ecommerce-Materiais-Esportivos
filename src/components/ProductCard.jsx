    ...
    return ( 
        <>
            ...
            h-[264px] lg:h-[439px]" >
                ...
                <img src={image} alt="Produto" className="
                w-[163px] lg:w-[292px] 
                h-[179px] lg:h-[321px] object-cover" />
                </Link>
                <h6 className="text-[5px] lg:text-[10px] font-bold text-ligth-gray pt-3">{tilte}</h6>
                <h3 className=" text-[14px] lg:text-[28px] text-dark-gray2">{description}</h3>
