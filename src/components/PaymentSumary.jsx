...
export const PaymentSummary = ({ 
    ...
    return (
        ...
        <section className="w-full rounded-md p-5">
            {/* Linha do Total */}
            <div className="mt-4 pt-4 flex justify-between items-center">
                <h2 className="text-gray-800 font-bold text-[18px] lg:text-[20px]">Total a Pagar</h2>
                <div className="flex flex-col items-end">
                    <h2 className="text-red-500 font-bold text-[18px] lg:text-[22px]">{formatPrice(total)}</h2>
                    <h3 className="text-gray-500 text-[10px] lg:text-[12px] mt-1">
