      ...
      <main className="w-full h-screen flex bg-gradient-to-b from-secondary to-secondaryFundo">
        ...
        >
          <div
            className="
                      bg-white 
                      max-w-[315px] max-h-[572px] 
                      lg:min-w-[583px] lg:min-h-[560px] 
                      flex flex-col 
          ...
          >
            ...
            <h3 className="text-[14px] ">
              <span>
                ...
                <Link className="underline hover:text-slate-400">aqui</Link>
              </span>
            </h3>
            <fieldset className="flex flex-col w-full gap-5">
              ...
              />
              <Link>
                <button className="underline hover:text-slate-400 text-[14px]">
                  Esqueci minha senha
                </button>
              </Link>
            </fieldset>
